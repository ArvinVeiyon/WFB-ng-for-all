...
11. You can specify *multiple nics* (in /etc/default/wifibroadcast) if you have multiple directed and/or omnidirected antennas. Active adapter will be selected on RSSI or RX signal from peer. In case of rtl8812au cards with two antennas you can enable STBC to use both of them for tx simultaneously.